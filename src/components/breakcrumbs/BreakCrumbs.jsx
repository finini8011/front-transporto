...
const BreakCrumbs = ({ handleNavigate }) => {
  ...
  const ComponentButtons = () => {
    ...
    if(path === "/home"){
      ...
      nextButton= "Paso 1"
    }else if (path === "/planificacion" || path === "/implementacion" || path === "/seguimiento" || path === "/mejora" ){
      prevLink = "/home"
      nextLink = "/step/1"
      prevButton = "Inicio"
      nextButton= "Paso 1"  
      ...
      prevButton = "Inicio"
      nextButton= "paso 2"  
    } else if (pieceCrumbs[1] === "step" && pieceCrumbs[2] !== "1" && pieceCrumbs[2] !== "24"){
    ...
    return (
      <div className="flex gap-2 uppercase text-sm items-center">
        ...
        <p className="cursor-pointer color-fourth hover:underline" onClick={() => handleNavigate(prevLink)}>
          {prevButton}
        </p>{" "}
        <p>|</p> ir a
        <p className="cursor-pointer color-fourth hover:underline" onClick={() => handleNavigate(nextLink)}>
          {nextButton}
        </p>
